import type { TokenAnalysis, ConvictionLabel } from '../../foundation/types.js'
...
const DIMENSIONS: DimensionWeight[] = [
  { name: 'security', weight: 0.20, scorer: scoreSecurityDimension },
  ...
  { name: 'botManipulation', weight: 0.10, scorer: scoreBotManipulationDimension },
]
