...
const { scoreHolderQualityDimension } = await import('../../../src/engine/scorers/holder-quality.js')
...
const { scoreBotManipulationDimension } = await import('../../../src/engine/scorers/bot-manipulation.js')
